...
func (s *eventService) GetEventDetails(ctx context.Context, id uuid.UUID, userID uuid.UUID) (*models.EventDetails, error) {
	return s.repo.GetEventDetails(ctx, id, userID)
